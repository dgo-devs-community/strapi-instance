...
export interface ApiEventoEvento extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Fecha: Schema.Attribute.DateTime &
      Schema.Attribute.DefaultTo<'2025-09-19T01:00:00.000Z'>;
    FechaRecurrente: Schema.Attribute.String;
    ...
    Tipo: Schema.Attribute.Enumeration<['Taller', 'Charlas', 'Meetup']>;
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    CTA: Schema.Attribute.Component<'button.main-cta', true>;
